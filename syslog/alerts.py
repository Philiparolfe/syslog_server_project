...
class AlertHandler:
    ...
    def send_alert(self, message):
        ...
        twilio = yaml_data["twilio_config"]
        if twilio["is_encrypted"] == True:
            if twilio["is_on"] == True:
            ...
            print("!!!\nSMS alerts via twilio have not been configured! add credentials in config.yaml\n!!!")
